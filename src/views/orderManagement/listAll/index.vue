<template>
  <div class="app-container">
    <el-card v-loading.fullscreen.lock="fullscreenLoading" class="box-card">
      <!--            条件查询-->
      <div>
        <!--                日期筛选-->
        <el-card>
          <el-dropdown @command="handleStatusFilterClick">
            <el-button split-button>
              {{ this.queryObject.orderInfo.status | switchStatus }}<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
          ...
          <el-divider direction="vertical" />
          记录ID
          <el-input v-model="queryObject.orderInfo.orderId" placeholder="请输入记录ID" style="width: 120px" />
